...
// into a key here and only ciphertext crosses the app's ipc.
//
// This lives in the gui and NOT in the deno service. On android a component
...
// The gui is loaded over an https origin on android and over a scheme
// registered as secure in electron, so `crypto.subtle` is present on both.
//
...
import { bytesToBase64, base64ToBytes } from '@main/common/services/base/base64';
import type { BackupEncryptionParams } from '@deno/utils/backup-archive.ts';
 ...
 * come from cryptoRandomBytes, TextEncoder, base64ToBytes and the zip writer, each of
